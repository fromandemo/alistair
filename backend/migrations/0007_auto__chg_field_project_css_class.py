...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'backend_project', 'css_class', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))
    ...
    models = {
        ...
        u'backend.project': {
            ...
            'css_class': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True'}),
