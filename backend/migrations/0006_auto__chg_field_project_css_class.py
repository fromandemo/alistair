...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Project.css_class'
        db.alter_column(u'backend_project', 'css_class', self.gf('django.db.models.fields.TextField')(max_length=20, null=True))

    def backwards(self, orm):

        # Changing field 'Project.css_class'
        db.alter_column(u'backend_project', 'css_class', self.gf('django.db.models.fields.TextField')(default=None, max_length=20))
    ...
    models = {
        ...
        u'backend.project': {
            ...
            'css_class': ('django.db.models.fields.TextField', [], {'max_length': '20', 'null': 'True'}),
