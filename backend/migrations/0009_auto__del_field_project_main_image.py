...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Project.main_image'
        db.delete_column(u'backend_project', 'main_image')


    def backwards(self, orm):
        # Adding field 'Project.main_image'
        db.add_column(u'backend_project', 'main_image',
