...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.main_image_url'
        db.add_column(u'backend_project', 'main_image_url',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=200, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Project.main_image_url'
        db.delete_column(u'backend_project', 'main_image_url')
